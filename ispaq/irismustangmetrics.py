...
_R_getMetricFunctionMetadata = robjects.r(
    "IRISMustangMetrics::getMetricFunctionMetadata"
)
...
def apply_simple_metric(
    av, starttime, endtime, r_stream, metric_function_name, *args, **kwargs
):
    """ "
...
def apply_correlation_metric(
    r_stream1, r_stream2, metric_function_name, *args, **kwargs
):
    """ "
